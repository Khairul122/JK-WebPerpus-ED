                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="kElas">
                                                                ...
                                                                <!-- XI -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="XI - Administrasi Perkantoran">XI - IPA</option>
                                                                <option value="XI - Farmasi">XI - IPS</option>
                                                                <!-- XII -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="XII - Administrasi Perkantoran">XII - IPA</option>
                                                                <option value="XII - Farmasi">XII - IPS</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Alamat </label>
            ...
            <form action="pages/function/Anggota.php?aksi=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Masukan NIS" name="nis" maxlength="10" required>
                    </div>
                    <div class="form-group">
